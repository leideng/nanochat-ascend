...
nanochat-ascend trains a small GPT chat model, adapted from Karpathy's nanochat for Ascend NPU (910C). Supports NPU, CUDA, and CPU backends. Uses UV for package management with Python 3.11.
...
# Pre-training (distributed, 8 GPUs/NPUs)
...
- **Device-agnostic**: NPU/CUDA/CPU autodetected; conditional imports and graceful fallbacks throughout.
