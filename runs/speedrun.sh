...
torchrun --standalone --nproc_per_node=16 --master-addr=127.0.0.1 -m scripts.base_train -- --depth=26 --target-param-data-ratio=8.25 --device-batch-size=8 --num-iterations=10 --sample-every=5 --run=$WANDB_RUN
