...
echo "Please run \"echo \$OMP_NUM_THREADS\" in your terminal to see the value of OMP_NUM_THREADS environment variable"
echo "Please run \"echo \$NANOCHAT_CONFIG\" in your terminal to see the value of NANOCHAT_CONFIG environment variable"